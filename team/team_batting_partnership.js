...
var team_batting_partnership=express.Router();


team_batting_partnership.route("/:team_name/:year")
...
.get(function(request,response,next){
        ...
        mongodb.connect("mongodb://localhost:27017/visualCric",function(error,db){
        	  ...
        	  var collection=db.collection("team_batting_partnership");
...
module.exports=team_batting_partnership;