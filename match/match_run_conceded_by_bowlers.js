...
var match_run_conceded_by_bowlers=express.Router();


match_run_conceded_by_bowlers.route("/:team1/:team2/:date")
...
.get(function(request,response,next){
      ...
      mongodb.connect("mongodb://localhost:27017/visualCric",function(error,db){
      	   ...
      	   var collection=db.collection("match_run_conceded_by_bowlers");
...
module.exports=match_run_conceded_by_bowlers;