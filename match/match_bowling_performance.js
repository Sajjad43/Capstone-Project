...
var match_bowling_performance=express.Router();



match_bowling_performance.route("/:team1/:team2/:date")
...
.get(function(request,response,next){
    ...
    mongodb.connect("mongodb://localhost:27017/visualCric",function(error,db){
    	  ...
    	  var collection=db.collection("match_bowling_performance");
...
module.exports=match_bowling_performance;